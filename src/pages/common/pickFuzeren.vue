<template>
   <!-- 选择负责人 -->
    ...
    <div class="item" @click="scrollEvt">
      <ul>
        <li v-for="(item, index) in list" :key="index" @click="userConfirm(item)">
...
import { getCityList, getUserListApi } from "../../apis/userApi"
...
export default {
  ...
  methods:{
    userConfirm (user) {
      this.$emit('userConfirm', user)
      this.$emit('update:show', false)

      // this.liableName = val.name
